namespace LibgenServer.Core.Database
{
    internal static class SqlScripts
    {
        ...
        public const string GET_NON_FICTION_FILE_BY_MD5HASH = "SELECT * FROM files f INNER JOIN non_fiction nf ON nf.FileId = f.Id " +
            "WHERE nf.Md5Hash = @Md5Hash COLLATE NOCASE";
